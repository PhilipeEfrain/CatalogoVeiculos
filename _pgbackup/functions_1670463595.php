...
if ( ! function_exists( 'modelo2_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'modelo2-popper', get_template_directory_uri() . '/assets/js/popper.min.js', [], '1.0.1', true);

    wp_deregister_script( 'modelo2-bootstrap' );
    wp_enqueue_script( 'modelo2-bootstrap', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', [], '1.0.1', true);

    wp_deregister_script( 'modelo2-all' );
    wp_enqueue_script( 'modelo2-all', 'https://use.fontawesome.com/releases/v5.13.1/js/all.js', [], '1.0.1', true);
    ...
    wp_enqueue_style( 'modelo2-bootstrap', get_template_directory_uri() . '/bootstrap/css/bootstrap.min.css', [], '1.0.1', 'all');

    wp_deregister_style( 'modelo2-blocks' );
    wp_enqueue_style( 'modelo2-blocks', get_template_directory_uri() . '/blocks.css', [], '1.0.1', 'all');

    wp_deregister_style( 'modelo2-style' );
    wp_enqueue_style( 'modelo2-style', get_bloginfo('stylesheet_url'), [], '1.0.1', 'all');

    wp_deregister_style( 'modelo2-fontawesome' );
    wp_enqueue_style( 'modelo2-fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', [], '1.0.1', 'all');

    wp_deregister_style( 'modelo2-all' );
    wp_enqueue_style( 'modelo2-all', 'https://use.fontawesome.com/releases/v5.13.1/css/all.css', [], '1.0.1', 'all');
