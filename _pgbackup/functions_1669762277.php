...
function modelo2_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'insticional_compra', array(
        'title' => __( 'Bloco Compra', 'modelo2' )
    ));
    ...
    $wp_customize->add_setting( 'insticional_bloco_compra', array(
        'type' => 'theme_mod',
        'default' => __( 'Compra', 'modelo2' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'insticional_bloco_compra', array(
        'label' => __( 'Chamada de compra', 'modelo2' ),
        'type' => 'text',
        'section' => 'insticional_compra'
    ));
    ...
    $wp_customize->add_setting( 'address_contact_number', array(
        'type' => 'theme_mod',
        'default' => __( '+1 234 567-890', 'modelo2' ),
        'sanitize_callback' => $pgwp_sanitize
    ));
    ...
    $wp_customize->add_setting( 'address_contact_email', array(
        'type' => 'theme_mod',
        'default' => __( 'hello@fantico.com', 'modelo2' ),
        'sanitize_callback' => $pgwp_sanitize
    ));
