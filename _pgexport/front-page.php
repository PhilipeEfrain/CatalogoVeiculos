<?php get_header(); ?>
        ...
        <section class="text-white-50"> 
            <div class="background-cover bg-secondary overflow-hidden pb-4 pb-md-5 pe-4 pe-lg-5 ps-4 ps-lg-5 pt-5" style="background-image:<?php echo 'url('.PG_Image::getUrl( get_theme_mod( 'top_img' ), 'large' ).')' ?>; background-repeat: no-repeat; background-position: center center; background-size: cover;"> 
                <div class="container"> 
                    <div class="pb-md-5 pt-5 row"> 
                        <div class="col-md-8 col-xl-4 pb-md-5 pt-5"> 
                            <p class="h5 text-primary text-uppercase" style="color:<?php echo get_theme_mod( 'top_call_color' ); ?> !important;"><?php echo get_theme_mod( 'top_call', __( 'Adopt A Pet', 'bmotorsautomoveis' ) ); ?></p> 
                            <h1 class="display-4 fw-bold text-capitalize text-white" style="color:<?php echo get_theme_mod( 'top_title_color' ); ?> !important;"><?php echo get_theme_mod( 'top_title', __( 'Thousands of homeless dogs, one act of kindness', 'bmotorsautomoveis' ) ); ?></h1> 
                            <p class="fw-light mb-4" style="color:<?php echo get_theme_mod( 'top_describe_color' ); ?> !important;"><?php echo get_theme_mod( 'top_describe', __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac sagittis neque, vel egestas est.', 'bmotorsautomoveis' ) ); ?></p> 
            ...
            <section> 
                <div class="container pb-4 pt-4"> 
                    <div class="align-items-center row"> 
                        ...
                        <div class="col-auto"> 
                            <h2 class="fw-normal lead mb-0 text-dark"><?php _e( 'Catálogo', 'bmotorsautomoveis' ); ?></h2> 
                        </div>                         
                        <div class="col"> 
                            <hr class="mb-0 mt-0"/> 
                        </div>                         
                ...
                <div class="container"> 
                    <div class="row"> 
                        <div class="col-md-9"> 
                            <div class="justify-content-center row"> 
                                ...
                                <?php else : ?>
                                    <p><?php _e( 'Sorry, no posts matched your criteria.', 'bmotorsautomoveis' ); ?></p>
                                <?php endif; ?>                                                                                                                                                                                                                                        
                            </div>                             
                        </div>                         
                    ...
                    <div class="pb-4 pt-4 text-center"> <a href="<?php echo get_theme_mod( 'link_shop_button_link', '#' ); ?>" class="btn btn-dark pb-2 ps-4 pe-4 pt-2"><?php echo get_theme_mod( 'name_shop_button', __( 'Veja todo o catalogo', 'bmotorsautomoveis' ) ); ?></a> 
                    </div>                     
                </div>                 
            </section>             
        </section>         
                    ...
                    <div class="container-fluid pb-5 pt-5"> 
                        <div class="align-items-center mb-3 row"> 
                            <div class="col-xl-4 pb-4 pt-4"> 
                                <h2 class="h6 mb-1 text-primary" style="color:<?php echo get_theme_mod( 'color_chamada' ); ?> !important;"><?php echo get_theme_mod( 'insticional_chamada', __( 'Services', 'bmotorsautomoveis' ) ); ?></h2> 
                                <h3 class="fw-bold h2 mb-1"><?php echo get_theme_mod( 'insticional_titulo', __( 'We can do useful things for our clients', 'bmotorsautomoveis' ) ); ?></h3> 
                                <p class="fw-light"><?php echo get_theme_mod( 'insticional_texto', __( 'You never change things by fighting the existing reality. To change something, build a new model that makes the existing model obsolete.', 'bmotorsautomoveis' ) ); ?></p> <a href="<?php echo get_theme_mod( 'insticional_button_link', '#' ); ?>" class="bg-black btn pb-2 pe-4 ps-4 pt-2 rounded-pill text-white"><?php echo get_theme_mod( 'insticional_button', __( 'Learn More', 'bmotorsautomoveis' ) ); ?></a> 
                            </div>                             
                                ...
                                <div class="row"> 
                                    <div class="col-md-4 pb-3 pt-3"> 
                                        <div class="pb-3 pt-3"> 
                                            ...
                                            <?php endif; ?> 
                                            <h4 class="fw-bold h5 text-dark"><?php echo get_theme_mod( 'insticional_bloco01', __( 'Compra', 'bmotorsautomoveis' ) ); ?></h4> 
                                            <p class="text-secondary"><?php echo get_theme_mod( 'insticional_bloco01_texto', __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.', 'bmotorsautomoveis' ) ); ?></p>
                                            <a href="<?php echo get_theme_mod( 'insticional_bloco01_botao_link', '#' ); ?>" class="text-black"><?php echo get_theme_mod( 'insticional_bloco01_botao', __( 'Learn More', 'bmotorsautomoveis' ) ); ?></a> 
                                        </div>                                         
                                    </div>                                     
                                    <div class="col-md-4 pb-3 pt-3"> 
                                        <div class="pb-3 pt-3"> 
                                            ...
                                            <?php endif; ?> 
                                            <h4 class="fw-bold h5 text-dark"><?php echo get_theme_mod( 'insticional_bloco02', __( 'Venda', 'bmotorsautomoveis' ) ); ?></h4> 
                                            <p class="text-secondary"><?php echo get_theme_mod( 'insticional_bloco02_texto', __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.', 'bmotorsautomoveis' ) ); ?></p>
                                            <a href="<?php echo get_theme_mod( 'insticional_bloco02_botao_link', '#' ); ?>" class="text-black"><?php echo get_theme_mod( 'insticional_bloco02_botao', __( 'Learn More', 'bmotorsautomoveis' ) ); ?></a> 
                                        </div>                                         
                                    </div>                                     
                                    <div class="col-md-4 pb-3 pt-3"> 
                                        <div class="pb-3 pt-3"> 
                                            ...
                                            <?php endif; ?> 
                                            <h4 class="fw-bold h5 text-dark"><?php echo get_theme_mod( 'insticional_bloco03', __( 'Ligamos pra você', 'bmotorsautomoveis' ) ); ?></h4> 
                                            <p class="text-secondary"><?php echo get_theme_mod( 'insticional_bloco03_texto', __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.', 'bmotorsautomoveis' ) ); ?></p>
                                            <a href="<?php echo get_theme_mod( 'insticional_bloco03_botao_link', '#' ); ?>" class="text-black"><?php echo get_theme_mod( 'insticional_bloco03_botao', __( 'Learn More', 'bmotorsautomoveis' ) ); ?></a> 
                                        </div>                                         
                                    </div>                                     
                                </div>                                 
                            </div>                             
