                ...
                <div class="row"> 
                    <div class="col-xl-4 py-3"> <a href="<?php echo esc_url( home_url() ); ?>" class="d-inline-block fw-bold h2 link-light mb-4 text-decoration-none" rel="home"><?php bloginfo( 'name' ); ?></a> 
                        <?php if ( get_theme_mod( 'shop_footer_text' ) ) : ?>
                            <p class="mb-3"><?php echo get_theme_mod( 'shop_footer_text', __( 'Duis pharetra venenatis felis, ut tincidunt ipsum consequat nec. Fusce et porttitor libero, eu aliquam nisi. Nam finibus ullamcorper semper.', 'catalogo_veiculos' ) ); ?></p>
                        <?php endif; ?> 
                        <div class="mb-4"> <a href="<?php echo get_theme_mod( 'shop_footer_phone_url', '#' ); ?>" class="link-light text-decoration-none"><?php echo get_theme_mod( 'shop_footer_phone', __( '+1 234 567-890', 'catalogo_veiculos' ) ); ?></a> <br/> <a href="<?php echo get_theme_mod( 'shop_footer_email_url', '#' ); ?>" class="link-light text-decoration-none"><?php echo get_theme_mod( 'shop_footer_email', __( 'hello@company.com', 'catalogo_veiculos' ) ); ?></a> 
                        </div>                         
                    </div>                     
                    <div class="col-md-3 col-xl-2 py-3"> 
                        <h2 class="fw-normal h5 mb-4 text-uppercase text-white"><?php echo get_theme_mod( 'shop_footer_colum1_heading', __( 'About', 'catalogo_veiculos' ) ); ?></h2> 
                    ...
                    <div class="col-md-3 col-xl-2 py-3"> 
                        <h2 class="fw-normal h5 mb-4 text-uppercase text-white"><?php echo get_theme_mod( 'shop_footer_column2_heading', __( 'Services', 'catalogo_veiculos' ) ); ?></h2> 
                    ...
                    <div class="col-md-6 col-xl-4 py-3"> 
                        <h2 class="fw-normal h5 mb-4 text-uppercase text-white"><?php echo get_theme_mod( 'shop_footer_column3_heading', __( 'Subscribe', 'catalogo_veiculos' ) ); ?></h2> 
                        <p class="mb-3"><?php echo get_theme_mod( 'shop_footer_subscribe_text', __( 'Subscribe to our newsletter and get exclusive updates directly in your inbox.', 'catalogo_veiculos' ) ); ?></p> 
                        ...
                        <?php endif; ?> 
                        <h2 class="fw-normal h5 mb-3 text-uppercase text-white"><?php echo get_theme_mod( 'shop_footer_social_heading', __( 'Get Social', 'catalogo_veiculos' ) ); ?></h2> 
                ...
                <div class="pb-3 pt-3 small"> 
                    ...
                    <div class="align-items-center row"> 
                        <div class="col-md pb-2 pt-2"> 
                            <p class="mb-0">&copy; <span><?php echo date( 'Y' ); ?></span> | <span><?php echo get_theme_mod( 'shop_footer_copyright', __( 'All Rights Reserved - Company Name', 'catalogo_veiculos' ) ); ?></span></p> 
                        </div>                         
                        <div class="col-md-auto pb-2 pt-2">
                            <a href="<?php echo get_theme_mod( 'shop_footer_privacy_link', '#' ); ?>" class="link-light text-decoration-none"><?php _e( 'Privacy Policy', 'catalogo_veiculos' ); ?></a> | <a href="<?php echo get_theme_mod( 'shop_footer_terms_link', '#' ); ?>" class="link-light text-decoration-none"><?php _e( 'Terms of Use', 'catalogo_veiculos' ); ?></a> 
                        </div>                         
                    </div>                     
                </div>                 
            </div>             
