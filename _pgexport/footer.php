            ...
            <footer class="bg-dark pt-5 text-white"> 
                <div class="container"> 
                    ...
                    <div class="pb-3 pt-3 text-center"> 
                        ...
                        <div class="row"> 
                            <div class="col-md-6"> 
                                <p class="mb-0 text-center text-md-start text-sm-center"><?php echo get_theme_mod( 'copyright', __( 'Copyright © 2020 Company Name', 'bmotorsautomoveis' ) ); ?></p> 
                            </div>                             
                            <div class="col-md-6"> 
                                <p class="mb-0 text-end text-md-end text-sm-center"><?php echo get_theme_mod( 'dev', __( 'Copyright © 2020 Company Name', 'bmotorsautomoveis' ) ); ?></p> 
                            </div>                             
                        </div>                         
                    </div>                     
                </div>                 
