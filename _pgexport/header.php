                        ...
                        <div class="col"> 
                            <div class="row">
                                <div class="col-md-auto">
                                    <i class="fa-phone-alt fa-sm fas"></i>
                                    <a href="<?php echo get_theme_mod( 'address_contact_number_link', '#' ); ?>" class="me-md-2 text-black underlinenot"><?php echo get_theme_mod( 'address_contact_number', '<span class="me-md-1"> </span> <span class="d-md-inline d-none"> +0-123-456-789 </span>' ); ?></a>                                      
                                </div>
                                <div class="col-md-auto">
                                    <span class="me-md-1"> <i class="fa-envelope fa-sm fas"></i> </span>
                                    <a href="<?php echo get_theme_mod( 'address_contact_email_link', '#' ); ?>" class="me-md-2 text-black underlinenot"><?php echo get_theme_mod( 'address_contact_email', '<span class="d-md-inline d-none"> info@company.com </span>' ); ?></a>                                      
                                </div>
                            </div>                             
                        </div>                         
                        <div class="col-auto"> 
                            <div class="py-1"> <a href="<?php echo get_theme_mod( 'address_contact_facebook', '#' ); ?>" aria-label="facebook" class="text-black underlinenot" target="_blank"> <i class="fa-facebook fa-lg fab"></i> </a> <a href="<?php echo get_theme_mod( 'address_contact_instagram', '#' ); ?>" aria-label="instagram" class="text-black underlinenot" target="_blank"> <i class="fa-instagram fa-lg fab"></i> </a><a href="<?php echo get_theme_mod( 'address_contact_tiktop', '#' ); ?>" aria-label="twitter" class="text-black underlinenot" target="_blank"> <i class="fa-lg fa-tiktok fab"></i> </a> 
                            </div>                             
                        </div>                         
                    </div>                     
                </div>                 
