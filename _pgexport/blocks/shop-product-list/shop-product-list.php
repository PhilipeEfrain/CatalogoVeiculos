    ...
    <div class="container"> 
        <?php
            $product_query_args = array(
                'post_type' => 'product',
                'posts_per_page' => PG_Blocks::getAttributeForAction( $args, 'count' ),
                'paged' => get_query_var( 'paged' ) ?: 1,
                'order' => PG_Blocks::getAttributeForAction( $args, 'direction' ),
                'orderby' => PG_Blocks::getAttributeForAction( $args, 'orderby' ),
