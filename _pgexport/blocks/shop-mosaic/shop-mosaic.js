...
( function ( blocks, element, blockEditor ) {
    ...
    const block = registerBlockType( 'catalogo-veiculos/shop-mosaic', {
        apiVersion: 2,
        title: 'Shop Mosaic',
        icon: 'block-default',
        category: 'shop',
        ...
        edit: function ( props ) {
            ...
            return el(Fragment, {}, [
                el('div', { ...blockProps }, el('div', { className: 'g-0 row' }, [props.attributes.image_1 && props.attributes.image_1.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_1.svg, 'image_1', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_1 && !props.attributes.image_1.svg && propOrDefault( props.attributes.image_1.url, 'image_1', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_1.url, 'image_1', 'url' ), alt: propOrDefault( props.attributes.image_1?.alt, 'image_1', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_1.id ? ('wp-image-' + props.attributes.image_1.id) : '') }), props.attributes.image_2 && props.attributes.image_2.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_2.svg, 'image_2', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_2 && !props.attributes.image_2.svg && propOrDefault( props.attributes.image_2.url, 'image_2', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_2.url, 'image_2', 'url' ), alt: propOrDefault( props.attributes.image_2?.alt, 'image_2', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_2.id ? ('wp-image-' + props.attributes.image_2.id) : '') }), props.attributes.image_3 && props.attributes.image_3.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_3.svg, 'image_3', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_3 && !props.attributes.image_3.svg && propOrDefault( props.attributes.image_3.url, 'image_3', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_3.url, 'image_3', 'url' ), alt: propOrDefault( props.attributes.image_3?.alt, 'image_3', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_3.id ? ('wp-image-' + props.attributes.image_3.id) : '') }), props.attributes.image_4 && props.attributes.image_4.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_4.svg, 'image_4', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_4 && !props.attributes.image_4.svg && propOrDefault( props.attributes.image_4.url, 'image_4', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_4.url, 'image_4', 'url' ), alt: propOrDefault( props.attributes.image_4?.alt, 'image_4', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_4.id ? ('wp-image-' + props.attributes.image_4.id) : '') }), props.attributes.image_5 && props.attributes.image_5.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_5.svg, 'image_5', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_5 && !props.attributes.image_5.svg && propOrDefault( props.attributes.image_5.url, 'image_5', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_5.url, 'image_5', 'url' ), alt: propOrDefault( props.attributes.image_5?.alt, 'image_5', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_5.id ? ('wp-image-' + props.attributes.image_5.id) : '') }), props.attributes.image_6 && props.attributes.image_6.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_6.svg, 'image_6', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_6 && !props.attributes.image_6.svg && propOrDefault( props.attributes.image_6.url, 'image_6', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_6.url, 'image_6', 'url' ), className: 'col-2 img-fluid ' + (props.attributes.image_6.id ? ('wp-image-' + props.attributes.image_6.id) : ''), alt: propOrDefault( props.attributes.image_6?.alt, 'image_6', 'alt' ), width: '400', height: '400' })])),                        
        ...
        save: function(props) {
            const blockProps = useBlockProps.save({ className: 'container-fluid p-0' });
            return el('div', { ...blockProps }, el('div', { className: 'g-0 row' }, [props.attributes.image_1 && props.attributes.image_1.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_1.svg, 'image_1', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_1 && !props.attributes.image_1.svg && propOrDefault( props.attributes.image_1.url, 'image_1', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_1.url, 'image_1', 'url' ), alt: propOrDefault( props.attributes.image_1?.alt, 'image_1', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_1.id ? ('wp-image-' + props.attributes.image_1.id) : '') }), props.attributes.image_2 && props.attributes.image_2.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_2.svg, 'image_2', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_2 && !props.attributes.image_2.svg && propOrDefault( props.attributes.image_2.url, 'image_2', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_2.url, 'image_2', 'url' ), alt: propOrDefault( props.attributes.image_2?.alt, 'image_2', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_2.id ? ('wp-image-' + props.attributes.image_2.id) : '') }), props.attributes.image_3 && props.attributes.image_3.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_3.svg, 'image_3', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_3 && !props.attributes.image_3.svg && propOrDefault( props.attributes.image_3.url, 'image_3', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_3.url, 'image_3', 'url' ), alt: propOrDefault( props.attributes.image_3?.alt, 'image_3', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_3.id ? ('wp-image-' + props.attributes.image_3.id) : '') }), props.attributes.image_4 && props.attributes.image_4.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_4.svg, 'image_4', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_4 && !props.attributes.image_4.svg && propOrDefault( props.attributes.image_4.url, 'image_4', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_4.url, 'image_4', 'url' ), alt: propOrDefault( props.attributes.image_4?.alt, 'image_4', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_4.id ? ('wp-image-' + props.attributes.image_4.id) : '') }), props.attributes.image_5 && props.attributes.image_5.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_5.svg, 'image_5', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_5 && !props.attributes.image_5.svg && propOrDefault( props.attributes.image_5.url, 'image_5', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_5.url, 'image_5', 'url' ), alt: propOrDefault( props.attributes.image_5?.alt, 'image_5', 'alt' ), width: '400', height: '400', className: 'col-2 img-fluid ' + (props.attributes.image_5.id ? ('wp-image-' + props.attributes.image_5.id) : '') }), props.attributes.image_6 && props.attributes.image_6.svg && pgCreateSVG(RawHTML, {}, pgMergeInlineSVGAttributes(propOrDefault( props.attributes.image_6.svg, 'image_6', 'svg' ), { className: 'col-2 img-fluid' })), props.attributes.image_6 && !props.attributes.image_6.svg && propOrDefault( props.attributes.image_6.url, 'image_6', 'url' ) && el('img', { src: propOrDefault( props.attributes.image_6.url, 'image_6', 'url' ), className: 'col-2 img-fluid ' + (props.attributes.image_6.id ? ('wp-image-' + props.attributes.image_6.id) : ''), alt: propOrDefault( props.attributes.image_6?.alt, 'image_6', 'alt' ), width: '400', height: '400' })]));
        }                        
