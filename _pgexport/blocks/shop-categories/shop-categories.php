<div <?php if(empty($_GET['context']) || $_GET['context'] !== 'edit') echo get_block_wrapper_attributes( array() ); else echo 'data-wp-block-props="true"'; ?>> 
    <?php $terms = get_terms( array(
            ...
            'orderby' => 'name',
            'order' => 'ASC',
            'parent' => PG_Helper::getTermIDFromSlug( PG_Blocks::getAttributeForAction( $args, 'parent' ), 'product_cat' ),
            'hide_empty' => true
    ) ) ?>
    <section class="bg-light pb-5 pg-lib-item pt-5 text-secondary"> 
        <div class="container pb-5 pt-5"> 
            <h1 class="h2 mb-4 text-dark"><?php echo PG_Blocks::getAttribute( $args, 'title' ) ?></h1> 
            <?php if( !empty( $terms ) ) : ?>
